...
# TO-DO
1) Debug any multi-class classification issues
2) Investigate the coordinate ascent algorithm and fix any bugs.
3) Extend the documentation
4) Add a new algorithm
5) Implement better exit behavior.
