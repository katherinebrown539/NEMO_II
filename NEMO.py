...
############################################################################################################
	...
	def resetAlgorithmResults(self):
		...
		self.kb.executeQuery(stmt)
		stmt = "create table AlgorithmResults(algorithm_id varchar(16), algorithm_name varchar(255), data_source varchar(255), accuracy double, prec double, recall double, f1 double, confusion_matrix varchar(512))"
		self.kb.executeQuery(stmt)
